...
from networks.Geo_net.Geo_Spa import Geo_Net
...
parser.add_argument('--root_pet', type=str, default=r'/data/Task001_Hecktor', required=False, help='Root folder of all your images and labels')
parser.add_argument('--root_ct', type=str, default='./data_MR', required=False, help='Root folder of all your images and labels')
parser.add_argument('--root_prior_P', type=str, default=r'/data/Task001_Hecktor', required=False, help='Root folder of all your images and labels')
parser.add_argument('--root_prior_S', type=str, default=r'/data/Task001_Hecktor', required=False, help='Root folder of all your images and labels')
...
parser.add_argument('--trained_weights', default='./output/Hecktor/Geo_net/best_metric_model.pth', help='Path of pretrained/fine-tuned weights')

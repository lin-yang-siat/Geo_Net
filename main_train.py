...
parser.add_argument('--root_pet', type=str, default=r'/data/Task001_Hecktor', required=False, help='Root folder of all PET images and labels')
parser.add_argument('--root_ct', type=str, default=r'/data/Task001_Hecktor', required=False, help='Root folder of all CT images')
parser.add_argument('--root_prior_P', type=str, default=r'/data/Task001_Hecktor', required=False, help='Root folder of all geodesic prior')
parser.add_argument('--root_prior_S', type=str, default=r'/data/ask001_Hecktor', required=False, help='Root folder of all geodesic sequenens')
...
parser.add_argument('--network', type=str, default='Geo_Net',
                    help='Network models: {Geo_Net, SwinUNETR}')
    ...
    def validation(epoch_iterator_val):
        ...
        with torch.no_grad():
            for step, batch in enumerate(epoch_iterator_val):
                ...
                val_outputs = sliding_window_inference(val_pet_inputs, (48, 48, 48), 2, model)
                ...
                epoch_iterator_val.set_description(
                    "Validate (%d / %d Steps) (dice=%2.5f)" % (global_step, 50.0, dice)
                )
            dice_metric.reset()

...
def data_loader(args):
    ...
    if dataset == 'pet':
        ...
        if args.mode == 'train':
            ...
            valid_samples = {}
            ## Input training data
            train_img = sorted(glob.glob(os.path.join(root_pet_dir, 'imagesAll', '*_0000.nii.gz')))
            train_label = sorted(glob.glob(os.path.join(root_pet_dir, 'labelsAll', '*.nii.gz')))
            ...
            test_img = sorted(glob.glob(os.path.join(root_pet_dir, 'imagesVal', '*.nii.gz')))
            test_label = sorted(glob.glob(os.path.join(root_pet_dir, 'labelsVal', '*.nii.gz')))
        ...
        print('Start to load data from directory: {}'.format(root_ct_dir))
        if args.mode == 'train':
            train_samples = {}
            valid_samples = {}
            ## Input training data
            train_img = sorted(glob.glob(os.path.join(root_ct_dir, 'imagesTr', '*.nii.gz')))
            train_label = sorted(glob.glob(os.path.join(root_ct_dir, 'labelsTr', '*.nii.gz')))
            train_samples['images'] = train_img
            train_samples['labels'] = train_label
            ## Input validation data
            valid_img = sorted(glob.glob(os.path.join(root_ct_dir, 'imagesVal', '*.nii.gz')))
            ...
            test_samples = {}
            ## Input inference data
            test_img = sorted(glob.glob(os.path.join(root_ct_dir, 'imagesTs', '*.nii.gz')))
            test_samples['images'] = test_img
            print('Finished loading all inference samples from dataset: {}!'.format(dataset))
            return test_samples
        ...
        if args.mode == 'train':
            ...
            train_ct_img = sorted(glob.glob(os.path.join(root_ct_dir, 'imagesTr', '*.nii.gz')))
            train_label = sorted(glob.glob(os.path.join(root_ct_dir, 'labelsTr', '*.nii.gz')))
            train_samples['images_pet'] = train_pet_img
            train_samples['images_ct'] = train_ct_img
            train_samples['labels'] = train_label
            ## Input validation data
            valid_pet_img = sorted(glob.glob(os.path.join(root_pet_dir, 'imagesVal', '*.nii.gz')))
            valid_ct_img = sorted(glob.glob(os.path.join(root_ct_dir, 'imagesVal', '*.nii.gz')))
            valid_label = sorted(glob.glob(os.path.join(root_ct_dir, 'labelsVal', '*.nii.gz')))
            ...
            test_ct_img = sorted(glob.glob(os.path.join(root_ct_dir, 'imagesTs', '*.nii.gz')))
        ...
        if args.mode == 'train':
            ...
            valid_samples = {}
            ## Input training data
            train_pet_img = sorted(glob.glob(os.path.join(root_pet_dir, 'imagesTr1', '*_0000.nii.gz')))
            train_P_img = sorted(glob.glob(os.path.join(root_prior_P_dir, 'PriorTr1', '*_0001.nii.gz')))
            train_S_1_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesTr1', '*_0002.nii.gz')))
            train_S_2_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesTr1', '*_0003.nii.gz')))
            train_S_3_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesTr1', '*_0004.nii.gz')))
            train_S_4_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesTr1', '*_0005.nii.gz')))
            train_S_5_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesTr1', '*_0006.nii.gz')))
            train_S_6_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesTr1', '*_0007.nii.gz')))
            train_S_7_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesTr1', '*_0008.nii.gz')))
            train_S_8_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesTr1', '*_0009.nii.gz')))

            train_label = sorted(glob.glob(os.path.join(root_pet_dir, 'labelsTr1', '*.nii.gz')))
            train_samples['images_pet'] = train_pet_img
            ...
            # valid_P_img = sorted(glob.glob(os.path.join(root_prior_P_dir, 'imagesVal', '*_0001.nii.gz')))
            valid_S1_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesVal', '*_0002.nii.gz')))
            valid_S2_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesVal', '*_0003.nii.gz')))
            valid_S3_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesVal', '*_0004.nii.gz')))
            valid_S4_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesVal', '*_0005.nii.gz')))
            valid_S5_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesVal', '*_0006.nii.gz')))
            valid_S6_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesVal', '*_0007.nii.gz')))
            valid_S7_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesVal', '*_0008.nii.gz')))
            valid_S8_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'SeriesVal', '*_0009.nii.gz')))
            ...
            test_P_img = sorted(glob.glob(os.path.join(root_prior_P_dir, 'imagesTs', '*_0001.nii.gz')))
            test_S1_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'imagesTs', '*_0002.nii.gz')))
            test_S2_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'imagesTs', '*_0003.nii.gz')))
            test_S3_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'imagesTs', '*_0004.nii.gz')))
            test_S4_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'imagesTs', '*_0005.nii.gz')))
            test_S5_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'imagesTs', '*_0006.nii.gz')))
            test_S6_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'imagesTs', '*_0007.nii.gz')))
            test_S7_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'imagesTs', '*_0008.nii.gz')))
            test_S8_img = sorted(glob.glob(os.path.join(root_prior_S_dir, 'imagesTs', '*_0009.nii.gz')))
    ...
    if dataset == 'pet':
        ...
        train_transforms = Compose(
            [
                ...
                AddChanneld(keys=["image_pet", "image_ct", "label"]),
        ...
        test_transforms = Compose(
            [
                ...
                AddChanneld(keys=["image_pet", "image_ct"]),
        ...
        train_transforms = Compose(
            [
                ...
                AddChanneld(keys=["images_pet", "Prior_P", "Prior_S_1", "Prior_S_2", "Prior_S_3"
                    , "Prior_S_4", "Prior_S_5", "Prior_S_6", "Prior_S_7", "Prior_S_8", "label"]),

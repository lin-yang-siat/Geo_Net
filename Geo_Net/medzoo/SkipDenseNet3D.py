...
from medzoo.BaseModelClass import BaseModel
...
class SkipDenseNet3D(BaseModel):
    ...
    def __init__(self, in_channels=1, classes=45, growth_rate=45, block_config=(4, 4, 4, 4), num_init_features=45, drop_rate=0.1,
                 bn_size=4):
